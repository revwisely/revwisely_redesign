...
const services = [
  {
    label: "Revenue Architecture Build",
    ...
    <section className="relative bg-[var(--off-white)] py-20 lg:py-28">
      <div ref={ref} className="mx-auto max-w-[1200px] px-6 lg:px-8">
        ...
        >
          ...
          >
            Revenue Architecture builds the foundation. Maestro adds the
            AI agent layer. Fractional Leadership keeps it all performing
