...
const audiences = [
  {
    ...
    body: "You\u2019re closing deals, managing pipeline, and trying to lead the company at the same time. A fractional sales leader takes the operational weight so you can focus on vision and growth.",
